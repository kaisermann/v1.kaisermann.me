		...
		<div class="project__list">
			...
			<div class="project__grid clear--after">
				<?php foreach ( $projects as $info ) :  ?>
					...
					?>
					<div class="project__item project--color-<?php echo $color; ?> animation--<?php echo $count++;  ?> <?php if ( ! $hasThumb ) { echo '-no-thumb'; } ?>">
						<a href="#projects/<?php echo $id; ?>" class="project__link">
							<div class="project__link-wrapper ">
								<?php if ( $hasThumb ) :  ?>
									<img src="<?php echo $main_url; ?>/<?php echo $thumbPath; ?>" alt="<?php echo $info['name']; ?>" />
								<?php endif; ?>
